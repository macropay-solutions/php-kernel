...
class Worker
{
    ...
    public function deleteAndFailJob(
        ...
        try {
            /**
             * @see \Illuminate\Queue\Worker::snapshotJobInCaseOfPhpError()
             */
    ...
    {
        return $this->cache instanceof \Illuminate\Contracts\Cache\Repository
            ? (int)$this->cache->get('illuminate:queue:restart')
            : null;
    }
