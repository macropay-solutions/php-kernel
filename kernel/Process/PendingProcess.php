...
class PendingProcess
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Process\Factory
     */
    protected $factory;
     ...
     *
     * @param \MacropaySolutions\Kernel\Process\Factory $factory
     * @return void
     */
     ...
     *
     * @throws \MacropaySolutions\Kernel\Process\Exceptions\ProcessTimedOutException
     ...
     * @param array<array-key, string>|string|null $command
     * @param callable|null $output
     * @return \MacropaySolutions\Kernel\Process\InvokedProcess
     *
     * @throws \RuntimeException
     */
    public function start(array|string|null $command = null, ?callable $output = null)
    {
        ...
        if ($fake = $this->fakeFor($command = $process->getCommandline())) {
            return tap(
                $this->resolveAsynchronousFake($command, $output, $fake),
                function (FakeInvokedProcess $process) {
     ...
     * @param callable|null $output
     * @param \Closure $fake
     * @return \MacropaySolutions\Kernel\Process\FakeInvokedProcess
     *
