...
class FakeProcessSequence
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Contracts\Process\ProcessResult|FakeProcessDescription
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Process\ProcessResult|FakeProcessDescription|array|string $process
     * @return $this
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Process\ProcessResult|FakeProcessDescription|array|string $process
     * @return \MacropaySolutions\Kernel\Contracts\Process\ProcessResult|FakeProcessDescription
     */
