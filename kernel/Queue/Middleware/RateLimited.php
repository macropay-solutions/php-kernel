...
use MacropaySolutions\Kernel\Cache\RateLimiter;
use MacropaySolutions\Kernel\Cache\RateLimiting\Unlimited;
...
class RateLimited
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Cache\RateLimiter
     */
    protected $limiter;
    ...
    public function handle($job, $next)
    {
        ...
        return $this->handleJob(
            ...
            collect(Arr::wrap($limiterResponse))->map(function ($limit) {
                return (object)[
                    'key' => \hash('md5', $this->limiterName . $limit->key),
