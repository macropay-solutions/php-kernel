...
use MacropaySolutions\Kernel\Queue\RedisQueue;
...
class RedisJob extends Job implements JobContract
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Queue\RedisQueue
     */
    protected $redis;
     ...
     * @param \MacropaySolutions\Kernel\Queue\RedisQueue $redis
     * @param string $job
     ...
     *
     * @return \MacropaySolutions\Kernel\Queue\RedisQueue
     */
