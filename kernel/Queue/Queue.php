...
abstract class Queue
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Container\Container
     */
    protected $container;
     ...
     * @return string
     *
     * @throws \MacropaySolutions\Kernel\Queue\InvalidPayloadException
     */
    ...
    protected function createObjectPayload($job, $queue)
    {
        $payload = $this->withCreatePayloadHooks($queue, [
            ...
            /**
             * @see \MacropaySolutions\Kernel\Queue\CallQueuedHandler::call()
             */
            'job' => 'MacropaySolutions\Kernel\Queue\CallQueuedHandler@call',
     ...
     *
     * @return \MacropaySolutions\Kernel\Container\Container
     */
