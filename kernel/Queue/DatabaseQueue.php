...
use MacropaySolutions\Kernel\Queue\Jobs\DatabaseJob;
use MacropaySolutions\Kernel\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param string $queue
     * @param \MacropaySolutions\Kernel\Queue\Jobs\DatabaseJobRecord $job
     * @param int $delay
     * @return mixed
     */
    ...
    public function getJobToBeFailedFromCachedData(array $data, ?string $queue = null): \MacropaySolutions\Kernel\Contracts\Queue\Job
    {
        return new DatabaseJob(
            $this->container,
            $this,
            new DatabaseJobRecord(\json_decode($data['job'])),
            $this->connectionName,
            $queue
        );
    }
     ...
     *
     * @param string|null $queue
     * @return \MacropaySolutions\Kernel\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param string $queue
     * @param \MacropaySolutions\Kernel\Queue\Jobs\DatabaseJobRecord $job
     * @return \MacropaySolutions\Kernel\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param string $queue
     * @param \MacropaySolutions\Kernel\Queue\Jobs\DatabaseJob $job
     * @param int $delay
     * @return void
     */
