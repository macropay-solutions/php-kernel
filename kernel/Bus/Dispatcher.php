...
use Closure;
use MacropaySolutions\Kernel\Contracts\Bus\QueueingDispatcher;
...
use MacropaySolutions\Kernel\Queue\Jobs\SyncJob;
...
class Dispatcher implements QueueingDispatcher
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Pipeline\Pipeline
     */
    protected $pipeline;
    ...
    {
        if (\is_array($command)) {
            $command = \MacropaySolutions\Kernel\Queue\CallQueuedCallable::create($command);
        }
     ...
     *
     * @param \MacropaySolutions\Kernel\Support\Collection|array|mixed $jobs
    ...
    public function chain($jobs)
    {
        ...
        throw new \RuntimeException('PendingChain not supported.');
//        return new PendingChain($jobs->shift(), $jobs->toArray());
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Queue\Queue $queue
     * @param mixed $command
     * @return mixed
     */
