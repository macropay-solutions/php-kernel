...
use MacropaySolutions\Kernel\Redis\Connections\PhpRedisClusterConnection;
use MacropaySolutions\Kernel\Redis\Connections\PhpRedisConnection;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param array $config
     * @param array $options
     * @return \MacropaySolutions\Kernel\Redis\Connections\PhpRedisConnection
     */
...
//        return new PhpRedisConnection($connector(), $connector, $config);
        return \di(PhpRedisConnection::class, [$connector(), $connector, $config]);
    }
     ...
     * @param array $options
     * @return \MacropaySolutions\Kernel\Redis\Connections\PhpRedisClusterConnection
     */
...
//        ));
        return \di(PhpRedisClusterConnection::class, [
