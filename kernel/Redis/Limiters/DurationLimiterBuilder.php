...
namespace MacropaySolutions\Kernel\Redis\Limiters;

use MacropaySolutions\Kernel\Contracts\Redis\LimiterTimeoutException;
...
class DurationLimiterBuilder
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Redis\Connections\Connection
     */
    public $connection;
     ...
     *
     * @param \MacropaySolutions\Kernel\Redis\Connections\Connection $connection
     * @param string $name
     * @return void
     */
     ...
     * @return mixed
     *
     * @throws \MacropaySolutions\Kernel\Contracts\Redis\LimiterTimeoutException
     */
