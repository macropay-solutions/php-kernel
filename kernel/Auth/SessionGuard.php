...
use MacropaySolutions\Kernel\Auth\Events\Failed;
use MacropaySolutions\Kernel\Auth\Events\Login;
use MacropaySolutions\Kernel\Auth\Events\Logout;
use MacropaySolutions\Kernel\Auth\Events\OtherDeviceLogout;
use MacropaySolutions\Kernel\Auth\Events\Validated;
...
use MacropaySolutions\Kernel\Contracts\Auth\SupportsBasicAuth;
    ...
    SupportsBasicAuth
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Contracts\Session\Session
     */
    protected $session;

    /**
     * The MacropaySolutions Kernel cookie creator service.
     *
     * @var \MacropaySolutions\Kernel\Contracts\Cookie\QueueingFactory
     */
    protected $cookie;
     ...
     *
     * @var \MacropaySolutions\Kernel\Support\Timebox
     */
    protected $timebox;
     ...
     *
     * @param \MacropaySolutions\Kernel\Auth\Recaller $recaller
     * @return mixed
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Auth\Recaller|null
     */
     ...
     *
     * @param mixed $id
     * @return \MacropaySolutions\Kernel\Contracts\Auth\Authenticatable|false
     */
    ...
    {
        if (!\app('hash')->check($password, $this->user()->{$attribute})) {
            throw new InvalidArgumentException('The given password does not match the current password.');
        }

        return tap($this->user()->forceFill([
            $attribute => \app('hash')->make($password),
        ]))->save();
    }
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Auth\Authenticatable|null $user
     * @param array $credentials
     * @return void
     */
    ...
    {
        return self::REMEMBER_ . $this->name . '_' . sha1(static::class);
    }
     ...
     *
     * @return \MacropaySolutions\Kernel\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Cookie\QueueingFactory $cookie
     * @return void
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Support\Timebox
     */
