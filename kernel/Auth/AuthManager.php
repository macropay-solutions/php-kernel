 ...
 * @mixin \MacropaySolutions\Kernel\Contracts\Auth\StatefulGuard
 */
class AuthManager implements FactoryContract
{
     ...
     * @param string $name
     * @param array $config
     * @return \MacropaySolutions\Kernel\Auth\SessionGuard
     */
...
//        );
     ...
     * @param string $name
     * @param array $config
     * @return \MacropaySolutions\Kernel\Auth\TokenGuard
     */
    ...
    /**
     * Forget all the resolved guard instances.
     *
     * @return $this
     */
