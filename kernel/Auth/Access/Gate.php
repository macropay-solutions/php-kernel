...
class Gate implements GateContract
{
    ...
    /**
     * All the defined abilities using class@method notation.
     *
     * @var array
     */
     ...
     *
     * @var \MacropaySolutions\Kernel\Auth\Access\Response|null
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Auth\Access\Response|\Closure|bool $condition
...
//                            : new Response(false, $message, $code);
                : \di(Response::class, [false, $message, $code]);
        } else {
            $response = $condition;
        }
...
//        ))->authorize();
        return with(
            $response instanceof Response ? $response : \di(
                Response::class,
                [(bool)$response === $allowWhenResponseIs, $message, $code]
            )
        )->authorize();
     ...
     *
     * @param \MacropaySolutions\Kernel\Auth\Access\Response $response
     * @return $this
     */
