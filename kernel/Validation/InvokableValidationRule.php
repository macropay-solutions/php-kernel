...
use MacropaySolutions\Kernel\Contracts\Validation\InvokableRule;
...
use MacropaySolutions\Kernel\Translation\CreatesPotentiallyTranslatedStrings;
...
class InvokableValidationRule implements Rule, ValidatorAwareRule
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Contracts\Validation\ValidationRule|\MacropaySolutions\Kernel\Contracts\Validation\InvokableRule
     */
    protected $invokable;
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Validation\ValidationRule|\MacropaySolutions\Kernel\Contracts\Validation\InvokableRule $invokable
     * @return void
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Validation\ValidationRule|\MacropaySolutions\Kernel\Contracts\Validation\InvokableRule $invokable
     * @return \MacropaySolutions\Kernel\Contracts\Validation\Rule|\MacropaySolutions\Kernel\Validation\InvokableValidationRule
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Contracts\Validation\ValidationRule|\MacropaySolutions\Kernel\Contracts\Validation\InvokableRule
     */
