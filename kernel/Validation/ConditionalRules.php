...
class ConditionalRules
{
     ...
     *
     * @var ValidationRule|InvokableRule|\MacropaySolutions\Kernel\Contracts\Validation\Rule|\Closure|array|string
     */
    protected $rules;
     ...
     * @param ValidationRule|InvokableRule|\MacropaySolutions\Kernel\Contracts\Validation\Rule|\Closure|array|string $rules
     * @param ValidationRule|InvokableRule|\MacropaySolutions\Kernel\Contracts\Validation\Rule|\Closure|array|string $defaultRules
     * @return void
     */
