...
trait DatabaseRule
{
     ...
     * @param \MacropaySolutions\Kernel\Contracts\Support\Arrayable|\BackedEnum|\Closure|array|string|int|bool|null $value
     * @return $this
     */
     ...
     *
     * @param string $column
     * @param \MacropaySolutions\Kernel\Contracts\Support\Arrayable|\BackedEnum|array|string $value
     * @return $this
     */
     ...
     *
     * @param string $column
     * @param \MacropaySolutions\Kernel\Contracts\Support\Arrayable|\BackedEnum|array $values
     * @return $this
     */
    ...
    /**
     * Get the target database column.
     */
    ...
    /**
     * Get the array of extra custom where clauses.
     */
