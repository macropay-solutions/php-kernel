...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param string $path
     * @param StreamInterface|\MacropaySolutions\Kernel\Http\File|\MacropaySolutions\Kernel\Http\UploadedFile|string|resource $contents
     * @param mixed $options
     * @return string|bool
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Http\File|\MacropaySolutions\Kernel\Http\UploadedFile|string $path
     * @param \MacropaySolutions\Kernel\Http\File|\MacropaySolutions\Kernel\Http\UploadedFile|string|array|null $file
     * @param mixed $options
     * @return string|false
     */
...
//        $file = is_string($file) ? new File($file) : $file;
        $file = is_string($file) ? \di(File::class, [$file]) : $file;
