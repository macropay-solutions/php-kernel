 ...
 * @mixin \MacropaySolutions\Kernel\Filesystem\FilesystemAdapter
 */
class FilesystemManager implements FactoryContract
{
     ...
     *
     * @return \MacropaySolutions\Kernel\Contracts\Filesystem\Cloud
     */
...
//        return new FilesystemAdapter($this->createFlysystem($adapter, $config), $adapter, $config);
        return \di(FilesystemAdapter::class, [$this->createFlysystem($adapter, $config), $adapter, $config]);
    }
...
//        );
    ...
    {
        return $this->app->make('config')->get('filesystems.cloud') ?? 's3';
    }
