...
trait EnumeratesValues
{
     ...
     * @template TMakeValue
     *
     * @param \MacropaySolutions\Kernel\Contracts\Support\Arrayable<TMakeKey, TMakeValue>|iterable<TMakeKey, TMakeValue>|null $items
...
//            : new static(Arr::wrap($value));
        return \di(static::class, [$value instanceof Enumerable ? $value : Arr::wrap($value)]);
    }
...
//        (new Collection(func_get_args()))
        \di(Collection::class, [func_get_args()])
            ->push($this->all())
            ->each(function ($item) {
                VarDumper::dump($item);
            });
     ...
     *
     * @param callable(TValue, TKey): (\MacropaySolutions\Kernel\Support\Collection<TFlatMapKey, TFlatMapValue>|array<TFlatMapKey, TFlatMapValue>) $callback
     ...
     *
     * @param string $key
     * @param \MacropaySolutions\Kernel\Contracts\Support\Arrayable|iterable $values
     * @param bool $strict
     * @return static
     */
...
//        return new Collection($this->all());
        return \di(Collection::class, [$this->all()]);
    }
