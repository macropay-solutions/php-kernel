...
//        return new static(range($from, $to));
        return \di(static::class, [\range($from, $to)]);
    }
     ...
     *
     * @return \MacropaySolutions\Kernel\Support\LazyCollection<TKey, TValue>
     */
    public function lazy()
    {
//        return new LazyCollection($this->items);
        return \di(LazyCollection::class, [$this->items]);
    }
     ...
     *
     * @param \MacropaySolutions\Kernel\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string $keys
     * @return static
     */
     ...
     *
     * \MacropaySolutions\Kernel\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TKey>|TKey  $keys
     *
     * @return $this
     */
    ...
    public function groupBy($groupBy, $preserveKeys = false)
    {
        ...
        if (!empty($nextGroups)) {
            return $result->map(static fn($group) => $group->groupBy($nextGroups, $preserveKeys));
        }
     ...
     *
     * @param \MacropaySolutions\Kernel\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string|null $keys
     * @return static
     */
     ...
     * @return TValue
     *
     * @throws \MacropaySolutions\Kernel\Support\ItemNotFoundException
     * @throws \MacropaySolutions\Kernel\Support\MultipleItemsFoundException
     */
    ...
    public function unique(null|callable|string $key = null, bool $strict = false, int $flags = SORT_REGULAR): static
    {
        ...
        return $this->reject(function ($item, $key) use ($callback, $strict, &$exists): bool {
     ...
     *
     * @return \MacropaySolutions\Kernel\Support\Collection<TKey, TValue>
     */
    public function toBase()
    {
//        return new self($this);
        return \di(self::class, [$this]);
    }
