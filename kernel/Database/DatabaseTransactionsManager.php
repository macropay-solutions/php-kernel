...
class DatabaseTransactionsManager
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Support\Collection<int, \MacropaySolutions\Kernel\Database\DatabaseTransactionRecord>
     */
...
//        $this->committedTransactions = new Collection;
        $this->committedTransactions = \di(Collection::class);
//        $this->pendingTransactions = new Collection;
        $this->pendingTransactions = \di(Collection::class);
    }
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\DatabaseTransactionRecord $transaction
     * @return void
     */
    ...
    /**
     * Get all the committed transactions.
     *
     * @return \MacropaySolutions\Kernel\Support\Collection
     */
