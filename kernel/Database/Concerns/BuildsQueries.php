...
trait BuildsQueries
{
     ...
     * @return \MacropaySolutions\Kernel\Database\Obvious\Model|object|static|null
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Query\Builder|\MacropaySolutions\Kernel\Database\Obvious\Builder $builder
     ...
     *
     * @param \MacropaySolutions\Kernel\Support\Collection $items
     * @param int $total
     * @param int $perPage
     * @param int $currentPage
     * @param array $options
     * @return \MacropaySolutions\Kernel\Pagination\LengthAwarePaginator
     */
     ...
     * @param int $currentPage
     * @param array $options
     * @return \MacropaySolutions\Kernel\Pagination\Paginator
     */
     ...
     * @param \MacropaySolutions\Kernel\Support\Collection $items
     * @param int $perPage
     * @param \MacropaySolutions\Kernel\Pagination\Cursor $cursor
     * @param array $options
     * @return \MacropaySolutions\Kernel\Pagination\CursorPaginator
     */
