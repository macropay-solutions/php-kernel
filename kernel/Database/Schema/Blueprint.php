...
class Blueprint
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \MacropaySolutions\Kernel\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @return \MacropaySolutions\Kernel\Support\Fluent
     */
     ...
     * @return \MacropaySolutions\Kernel\Database\Schema\IndexDefinition
     */
     ...
     * @param string|array $columns
     * @param string|null $name
     * @return \MacropaySolutions\Kernel\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param string $column
     * @return \MacropaySolutions\Kernel\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param string $column
     * @return \MacropaySolutions\Kernel\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Schema\ColumnDefinition $definition
     * @return \MacropaySolutions\Kernel\Database\Schema\ColumnDefinition
     */
