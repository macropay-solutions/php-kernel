...
abstract class Grammar
{
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Database\Query\Expression|string $value
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Database\Query\Expression|string|int|float $expression
