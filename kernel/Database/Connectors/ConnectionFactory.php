...
use MacropaySolutions\Kernel\Database\PostgresConnection;
...
class ConnectionFactory
{
     ...
     *
     * @param array $config
     * @return \MacropaySolutions\Kernel\Database\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
...
//            'mysql' => new MySqlConnection($connection, $database, $prefix, $config),
            'mysql' => \di(MySqlConnection::class, [$connection, $database, $prefix, $config]),
//            'pgsql' => new PostgresConnection($connection, $database, $prefix, $config),
            'pgsql' => \di(PostgresConnection::class, [$connection, $database, $prefix, $config]),
//            'sqlite' => new SQLiteConnection($connection, $database, $prefix, $config),
            'sqlite' => \di(SQLiteConnection::class, [$connection, $database, $prefix, $config]),
//            'sqlsrv' => new SqlServerConnection($connection, $database, $prefix, $config),
            'sqlsrv' => \di(SqlServerConnection::class, [$connection, $database, $prefix, $config]),
