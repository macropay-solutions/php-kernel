...
use MacropaySolutions\Kernel\Database\Concerns\BuildsQueries;
use MacropaySolutions\Kernel\Database\Concerns\ExplainsQueries;
use MacropaySolutions\Kernel\Database\ConnectionInterface;
use MacropaySolutions\Kernel\Database\Obvious\Builder as ObviousBuilder;
use MacropaySolutions\Kernel\Database\Obvious\Relations\Relation;
use MacropaySolutions\Kernel\Database\Query\Grammars\Grammar;
use MacropaySolutions\Kernel\Database\Query\Processors\Processor;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\Query\IndexHint
     */
    public $indexHint;
    ...
    /**
     * All the available bitwise operators.
     *
     * @var string[]
     */
     ...
     * @param \MacropaySolutions\Kernel\Database\Query\Grammars\Grammar|null $grammar
     * @param \MacropaySolutions\Kernel\Database\Query\Processors\Processor|null $processor
     * @return void
     */
     ...
     *
     * @param \Closure|\MacropaySolutions\Kernel\Database\Query\Builder|ObviousBuilder|string $query
     * @param string $as
     * @return $this
     *
    ...
    {
        if ($query instanceof self || $query instanceof ObviousBuilder || $query instanceof Relation) {
     ...
     *
     * @param \Closure|\MacropaySolutions\Kernel\Database\Query\Builder|ObviousBuilder|string $table
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Query\Builder $parentQuery
     * @param string $type
     * @param string $table
     * @return \MacropaySolutions\Kernel\Database\Query\JoinClause
     */
    protected function newJoinClause(self $parentQuery, $type, $table)
    {
//        return new JoinClause($parentQuery, $type, $table);
        return \di(JoinClause::class, [$parentQuery, $type, $table]);
    }
     ...
     * @param string $type
     * @param string $table
     * @return \MacropaySolutions\Kernel\Database\Query\JoinLateralClause
     */
    protected function newJoinLateralClause(self $parentQuery, $type, $table)
    {
//        return new JoinLateralClause($parentQuery, $type, $table);
        return \di(JoinLateralClause::class, [$parentQuery, $type, $table]);
    }
     ...
     *
     * @param string $column
     * @param \MacropaySolutions\Kernel\Contracts\Support\Arrayable|array $values
     * @param string $boolean
     * @param bool $not
     * @return $this
     */
     ...
     * @param ExpressionContract|string $column
     * @param string $operator
     * @param \Closure|\MacropaySolutions\Kernel\Database\Query\Builder|ObviousBuilder $callback
     * @param string $boolean
     * @return $this
     */
    protected function whereSub($column, $operator, $callback, $boolean)
    {
        ...
        if ($callback instanceof Closure) {
            ...
            $query = $callback instanceof ObviousBuilder ? $callback->toBase() : $callback;
        }
     ...
     *
     * @param \Closure|\MacropaySolutions\Kernel\Database\Query\Builder|ObviousBuilder|ExpressionContract|string $column
     ...
     *
     * @param \Closure|\MacropaySolutions\Kernel\Database\Query\Builder|ExpressionContract|string $column
     * @return $this
     */
     ...
     *
     * @param \Closure|\MacropaySolutions\Kernel\Database\Query\Builder|ExpressionContract|string|null $column
     * @param string $direction
     * @return $this
     */
     ...
     *
     * @param \Closure|\MacropaySolutions\Kernel\Database\Query\Builder|ObviousBuilder $query
     * @param bool $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \MacropaySolutions\Kernel\Database\RecordsNotFoundException
     ...
     * @return \MacropaySolutions\Kernel\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param string $pageName
     * @param int|null $page
     * @return \MacropaySolutions\Kernel\Contracts\Pagination\Paginator
     */
     ...
     * @param \MacropaySolutions\Kernel\Pagination\Cursor|string|null $cursor
     * @return \MacropaySolutions\Kernel\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Support\LazyCollection
     */
...
//        return new LazyCollection(function () {
        return \di(LazyCollection::class, [
            function () {
    ...
    /**
     * Get all the query builder's columns in a text-only array with all expressions evaluated.
     *
     * @return array
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Database\Query\Grammars\Grammar
     */
    ...
    protected function isQueryable($value)
    {
        return $value instanceof self ||
            $value instanceof ObviousBuilder ||
