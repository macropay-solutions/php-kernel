...
use MacropaySolutions\Kernel\Database\Events\StatementPrepared;
use MacropaySolutions\Kernel\Database\Events\TransactionBeginning;
use MacropaySolutions\Kernel\Database\Events\TransactionCommitted;
use MacropaySolutions\Kernel\Database\Events\TransactionCommitting;
use MacropaySolutions\Kernel\Database\Events\TransactionRolledBack;
...
use MacropaySolutions\Kernel\Database\Query\Grammars\Grammar as QueryGrammar;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\DatabaseTransactionsManager
     */
    ...
    /**
     * All the registered query duration handlers.
     *
     * @var array
     */
    ...
    /**
     * All the callbacks that should be invoked before a transaction is started.
     *
     * @var \Closure[]
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Database\Schema\Builder
     */
     ...
     *
     * @param \Closure|\MacropaySolutions\Kernel\Database\Query\Builder|\MacropaySolutions\Kernel\Contracts\Database\Query\Expression|string $table
     ...
     * @return mixed
     *
     * @throws \MacropaySolutions\Kernel\Database\MultipleColumnsSelectedException
     */
     ...
     * @return mixed
     *
     * @throws \MacropaySolutions\Kernel\Database\QueryException
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\QueryException $e
     * @param string $query
     * @param array $bindings
     * @param \Closure $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \MacropaySolutions\Kernel\Database\LostConnectionException
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Query\Grammars\Grammar $grammar
     * @return $this
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Schema\Grammars\Grammar $grammar
     * @return $this
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Query\Processors\Processor $processor
     * @return $this
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\DatabaseTransactionsManager $manager
     * @return $this
     */
     ...
     * @return \MacropaySolutions\Kernel\Database\Grammar
     */
