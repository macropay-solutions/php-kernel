...
namespace MacropaySolutions\Kernel\Database\Console\Migrations;
...
use MacropaySolutions\Kernel\Database\Events\SchemaLoaded;
use MacropaySolutions\Kernel\Database\Migrations\Migrator;
use MacropaySolutions\Kernel\Database\SQLiteDatabaseDoesNotExistException;
...
class MigrateCommand extends BaseCommand implements Isolatable
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\Migrations\Migrator
     */
    protected $migrator;
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Migrations\Migrator $migrator
