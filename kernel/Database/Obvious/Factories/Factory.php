...
abstract class Factory
{
     ...
     * @param \MacropaySolutions\Kernel\Support\Collection|null $states
     * @param \MacropaySolutions\Kernel\Support\Collection|null $has
     * @param \MacropaySolutions\Kernel\Support\Collection|null $for
     * @param \MacropaySolutions\Kernel\Support\Collection|null $afterMaking
     * @param \MacropaySolutions\Kernel\Support\Collection|null $afterCreating
     * @param string|null $connection
     * @param \MacropaySolutions\Kernel\Support\Collection|null $recycle
     * @return void
     */
...
//            return $this->for->isEmpty() ? $states : new Collection(array_merge([function () {
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Factories\Factory|\MacropaySolutions\Kernel\Support\Collection|Model|array $factory
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Factories\Factory|Model $factory
     * @param string|null $relationship
     * @return static
     */
     ...
     *
     * @param callable(class-string<Model>): class-string<\MacropaySolutions\Kernel\Database\Obvious\Factories\Factory> $callback
     * @return void
     */
     ...
     *
     * @param class-string<Model> $modelName
     * @return class-string<\MacropaySolutions\Kernel\Database\Obvious\Factories\Factory>
     */
