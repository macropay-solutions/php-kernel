...
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     *
     * @param array<array-key, (callable(\MacropaySolutions\Kernel\Database\Obvious\Builder): mixed)|string>|string $relations
     * @return $this
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Collection $models
     * @param array $path
     * @return void
     */
     ...
     * @template TZipValue
     *
     * @param \MacropaySolutions\Kernel\Contracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue> ...$items
     * @return BaseCollection<int, \MacropaySolutions\Kernel\Support\Collection<int, TModel|TZipValue>>
     */
    ...
    /**
     * Get the identifiers for all the entities.
     *
    ...
    /**
     * Get the Obvious query builder from the collection.
     *
