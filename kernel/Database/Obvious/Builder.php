...
use MacropaySolutions\Kernel\Database\Obvious\Concerns\QueriesRelationships;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\Query\Builder
     */
    protected $query;
    ...
    /**
     * The methods that should be returned from query builder AND for which the global scopes must be applied.
     *
     * @var string[]
     */
    protected $passthru = [
    ...
    /**
     * Create a new Obvious query builder instance.
     *
     ...
     * @return \MacropaySolutions\Kernel\Database\Obvious\Model|static
     */
     ...
     * @param \MacropaySolutions\Kernel\Database\Obvious\Scope|\Closure $scope
     * @return $this
     */
     ...
     *
     * @param \Closure|string|array|\MacropaySolutions\Kernel\Contracts\Database\Query\Expression $column
     ...
     * @param mixed $value
     * @param string $boolean
     * @return \MacropaySolutions\Kernel\Database\Obvious\Model|static|null
     */
     ...
     *
     * @param \Closure|array|string|\MacropaySolutions\Kernel\Contracts\Database\Query\Expression $column
     * @param mixed $operator
     * @param mixed $value
     * @return $this
     */
     ...
     *
     * @param string|\MacropaySolutions\Kernel\Contracts\Database\Query\Expression $column
     * @return $this
     */
     ...
     * @return \MacropaySolutions\Kernel\Database\Obvious\Model|\MacropaySolutions\Kernel\Database\Obvious\Collection|static[]|static|null
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Support\Arrayable|array $ids
     * @param array|string $columns
     * @return \MacropaySolutions\Kernel\Database\Obvious\Collection
     */
     ...
     * @param mixed $id
     * @param array|string $columns
     * @return \MacropaySolutions\Kernel\Database\Obvious\Model|\MacropaySolutions\Kernel\Database\Obvious\Collection|static|static[]
     *
     ...
     * @return \MacropaySolutions\Kernel\Database\Obvious\Model|\MacropaySolutions\Kernel\Database\Obvious\Collection|static[]|static|mixed
     */
     ...
     * @param \Closure|array|string $columns
     * @param \Closure|null $callback
     * @return \MacropaySolutions\Kernel\Database\Obvious\Model|static|mixed
     */
     ...
     *
     * @param array|string $columns
     * @return \MacropaySolutions\Kernel\Database\Obvious\Collection|static[]
     */
    ...
    public function getRelation($name)
    {
        ...
        $relation = Relation::noConstraints(function () use ($name) {
            try {
                ...
                return $model->callSegregatedRelation($name);
     ...
     *
     * @param array $attributes
     * @return \MacropaySolutions\Kernel\Database\Obvious\Model|$this
     */
    ...
    /**
     * Apply the scopes to the Obvious builder instance and return it.
     *
     * @return static
     */
    ...
    {
        // Here, we totally remove all the where clauses since we are going to
    ...
    /**
     * Get the Obvious builder instances that are used in the union of the query.
     *
     * @return \MacropaySolutions\Kernel\Support\Collection
     */
     ...
     *
     * @param array|\MacropaySolutions\Kernel\Contracts\Database\Query\Expression $columns
     * @return array
     */
    ...
    /**
     * Clone the Obvious query builder.
     *
     * @return static
     */
