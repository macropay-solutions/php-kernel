...
use MacropaySolutions\Kernel\Database\Obvious\PendingHasThroughRelationship;
...
//        return new MorphOne($query, $parent, $type, $id, $localKey);
    ...
    public function belongsTo($related, $foreignKey = null, $ownerKey = null, $relation = null)
    {
        ...
        // Once we have the foreign key names we'll just create a new Obvious query
...
//        return new MorphTo($query, $parent, $foreignKey, $ownerKey, $type, $relation);
     ...
     *
     * @param string|HasMany|\MacropaySolutions\Kernel\Database\Obvious\Relations\HasOne $relationship
     * @return \MacropaySolutions\Kernel\Database\Obvious\PendingHasThroughRelationship
     */
...
//        return new HasMany($query, $parent, $foreignKey, $localKey);
     ...
     * @param string|null $localKey
     * @param string|null $secondLocalKey
     * @return \MacropaySolutions\Kernel\Database\Obvious\Relations\HasManyThrough
     */
...
//        return new MorphMany($query, $parent, $type, $id, $localKey);
     ...
     *
     * @param string $related
     * @param string|class-string<\MacropaySolutions\Kernel\Database\Obvious\Model>|null $table
     * @param string|null $foreignPivotKey
     * @param string|null $relatedPivotKey
     * @param string|null $parentKey
     * @param string|null $relatedKey
     * @param string|null $relation
     * @return \MacropaySolutions\Kernel\Database\Obvious\Relations\BelongsToMany
     */
...
//            $relationName, $inverse);
     ...
     *
     * @param string $related
     * @param \MacropaySolutions\Kernel\Database\Obvious\Model|null $instance
     * @return string
     */
