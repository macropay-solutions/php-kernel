...
trait QueriesRelationships
{
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Relations\Relation|string $relation
     * @param string $operator
     * @param int $count
     * @param string $boolean
     * @param \Closure|null $callback
     * @return \MacropaySolutions\Kernel\Database\Obvious\Builder|static
     *
    ...
    public function has($relation, $operator = '>=', $count = 1, $boolean = 'and', ?Closure $callback = null)
    {
        ...
        // proper logical grouping of the where clauses if needed by this Obvious query
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Relations\MorphTo|string $relation
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Relations\MorphTo $relation
     * @param string $type
     * @return \MacropaySolutions\Kernel\Database\Obvious\Relations\BelongsTo
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Relations\MorphTo|string $relation
     * @param \MacropaySolutions\Kernel\Database\Obvious\Model|string|null $model
     * @return \MacropaySolutions\Kernel\Database\Obvious\Builder|static
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Relations\MorphTo|string $relation
     * @param \MacropaySolutions\Kernel\Database\Obvious\Model|string $model
     * @return \MacropaySolutions\Kernel\Database\Obvious\Builder|static
     */
     ...
     * @param \MacropaySolutions\Kernel\Contracts\Database\Query\Expression|string $column
     ...
     *
     * @param string $column
     * @param \MacropaySolutions\Kernel\Database\Obvious\Relations\Relation $relation
     * @return string
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Builder $hasQuery
     * @param \MacropaySolutions\Kernel\Database\Obvious\Relations\Relation $relation
     * @param string $operator
     * @param int $count
     * @param string $boolean
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Obvious\Builder $from
     * @return \MacropaySolutions\Kernel\Database\Obvious\Builder|static
     */
    ...
    protected function getRelationWithoutConstraints($relation)
    {
        return Relation::noConstraints(function () use ($relation) {
            ...
            return $model->callSegregatedRelation($relation);
        }, $relation);
    }
