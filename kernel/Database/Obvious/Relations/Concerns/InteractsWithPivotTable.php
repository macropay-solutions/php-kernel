...
trait InteractsWithPivotTable
{
    ...
    public function toggle($ids, $touch = true)
    {
        ...
        // Finally, for all the records which were not "detached", we'll attach the
     ...
     *
     * @param \MacropaySolutions\Kernel\Support\Collection|\MacropaySolutions\Kernel\Database\Obvious\Model|array $ids
     * @return array
     */
    ...
    public function sync($ids, $detaching = true)
    {
        ...
        // all the entities that exist in the "current" array but are not in the
    ...
    public function detach($ids = null, $touch = true)
    {
        if (
            ...
            // Once we have all the conditions set on the statement, we are ready
