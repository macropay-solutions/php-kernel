...
namespace MacropaySolutions\Kernel\Database\Migrations;
...
use MacropaySolutions\Kernel\Database\Events\MigrationsEnded;
use MacropaySolutions\Kernel\Database\Events\MigrationsStarted;
use MacropaySolutions\Kernel\Database\Events\MigrationStarted;
use MacropaySolutions\Kernel\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Database\Migrations\MigrationRepositoryInterface
     */
    ...
    /**
     * The paths to all the migration files.
     *
     * @var array
     */
    protected $paths = [];
     ...
     *
     * @var array<string, \MacropaySolutions\Kernel\Database\Migrations\Migration|null>
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Database\Migrations\MigrationRepositoryInterface $repository
     ...
     * @param \MacropaySolutions\Kernel\Contracts\Events\Dispatcher|null $dispatcher
     * @return void
     */
    ...
    {
        // Once we grab all the migration files for the path, we will compare them
    ...
    /**
     * Get all the queries that would be run for a migration.
     *
     * @param object $migration
     * @param string $method
     * @return array
    ...
    /**
     * Get all the custom migration paths.
     *
     * @return array
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Database\Events\MigrationEvent $event
     * @return void
     */
