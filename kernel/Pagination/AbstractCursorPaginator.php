...
abstract class AbstractCursorPaginator implements Htmlable
{
     ...
     * The current cursor.
     *
     * @var \MacropaySolutions\Kernel\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param \MacropaySolutions\Kernel\Pagination\Cursor|null $cursor
     * @return string
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Pagination\Cursor|null
     */
     ...
     * @param bool $isNext
     * @return \MacropaySolutions\Kernel\Pagination\Cursor
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Support\Collection $collection
     * @return $this
     */
