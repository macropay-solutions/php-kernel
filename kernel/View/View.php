...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @var \MacropaySolutions\Kernel\View\Factory
     */
    protected $factory;
     ...
     *
     * @var \MacropaySolutions\Kernel\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param \MacropaySolutions\Kernel\View\Factory $factory
     * @param \MacropaySolutions\Kernel\Contracts\View\Engine $engine
     * @param string $view
     * @param string $path
     * @param mixed $data
     * @return void
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Support\MessageProvider|array $provider
     * @param string $bag
     * @return $this
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Support\MessageProvider|array|string $provider
