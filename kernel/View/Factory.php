...
class Factory implements FactoryContract
{
     ...
     *
     * @var \MacropaySolutions\Kernel\View\Engines\EngineResolver
     */
    protected $engines;
     ...
     *
     * @var \MacropaySolutions\Kernel\View\ViewFinderInterface
     */
    protected $finder;
     ...
     *
     * @param \MacropaySolutions\Kernel\View\Engines\EngineResolver $engines
     ...
     * @return \MacropaySolutions\Kernel\Contracts\View\View
     */
...
//        return new View($this, $this->getEngineFromPath($path), $view, $path, $data);
        return \di(View::class, [$this, $this->getEngineFromPath($path), $view, $path, $data]);
    }
     ...
     *
     * @param string $path
     * @return \MacropaySolutions\Kernel\Contracts\View\Engine
     *
     * @throws \InvalidArgumentException
     */
    ...
    /**
     * Flush all the section contents if done rendering.
     *
     * @return void
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\View\Engines\EngineResolver
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\View\ViewFinderInterface
     */
    ...
    /**
     * Get all the shared data for the environment.
     *
     * @return array
     */
