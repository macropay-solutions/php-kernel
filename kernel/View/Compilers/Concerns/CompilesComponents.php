...
use MacropaySolutions\Kernel\View\ComponentAttributeBag;
...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = ' . $component . '::resolve(' . ($data ?: '[]') . ' + (isset($attributes) && $attributes instanceof MacropaySolutions\Kernel\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>',
    ...
    {
        return "<?php \$attributes ??= new \\MacropaySolutions\\Kernel\\View\\ComponentAttributeBag; ?>
