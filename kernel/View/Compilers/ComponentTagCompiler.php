    ...
    protected function componentString(string $component, array $attributes)
    {
        ...
        if (!class_exists($class)) {
            $view = Str::startsWith($component, 'mail::')
                ? "\$__env->getContainer()->make(MacropaySolutions\\Kernel\\View\\Factory::class)->make('{$component}')"
                : "'$class'";
...
<?php $component->withAttributes([' . $this->attributesToString(
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\View\Factory $viewFactory
     * @param string $component
     * @return string|null
     */
        ...
        return preg_replace_callback(
            ...
            function ($match) {
                if ($match[1] === 'class') {
                    ...
                    return ":class=\"\MacropaySolutions\Kernel\Support\Arr::toCssClasses{$match[2]}\"";
                }
        ...
        return preg_replace_callback(
            ...
            function ($match) {
                if ($match[1] === 'style') {
                    ...
                    return ":style=\"\MacropaySolutions\Kernel\Support\Arr::toCssStyles{$match[2]}\"";
                }
