...
class Command extends SymfonyCommand
{
    ...
    public static function getDefaultName(): ?string
    {
        ...
        if ($attribute = $reflection->getAttributes(AsCommand::class)) {
        ...
        if ('' !== (string)($defaultProperties['signature'] ?? '')) {
            $parsed = Parser::parse($defaultProperties['signature']);

            return (string)\reset($parsed);
        }
    ...
    public static function getDefaultDescription(): ?string
    {
        ...
        return $reflection->getDefaultProperties()['description'] ?? null;
    }
     ...
     *
     * @return \MacropaySolutions\Kernel\Console\CommandMutex
     */
    ...
    /**
     * Set the Kernel application instance.
     *
