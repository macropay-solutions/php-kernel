...
namespace MacropaySolutions\Kernel\Console\View\Components;

use MacropaySolutions\Kernel\Console\OutputStyle;
use MacropaySolutions\Kernel\Console\QuestionHelper;
use ReflectionClass;
...
abstract class Component
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Console\OutputStyle
     */
    protected $output;
     ...
     *
     * @param \MacropaySolutions\Kernel\Console\OutputStyle $output
     * @return void
     */
