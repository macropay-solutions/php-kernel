...
class Event
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Support\Carbon|null
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Console\Scheduling\EventMutex $mutex
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Mail\Mailer $mailer
...
//                            : $container->call($callback, ['output' => new Stringable($output)]);
                : $container->call($callback, ['output' => \di(Stringable::class, [$output])]);
        };
    }
