...
use MacropaySolutions\Kernel\Broadcasting\Broadcasters\RedisBroadcaster;
use MacropaySolutions\Kernel\Bus\UniqueLock;
use MacropaySolutions\Kernel\Contracts\Broadcasting\Factory as FactoryContract;
use MacropaySolutions\Kernel\Contracts\Broadcasting\ShouldBeUnique;
...
/**
 * @mixin \MacropaySolutions\Kernel\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
    ...
    public function routes(?array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\MacropaySolutions\Kernel\Session\Middleware\VerifyCsrfToken::class]);
        });
    }
