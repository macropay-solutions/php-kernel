...
namespace MacropaySolutions\Kernel\Cookie\Middleware;
...
class EncryptCookies
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Contracts\Encryption\Encrypter
     */
    protected $encrypter;

    /**
     * The names of the cookies that should not be encrypted.
     * DO NOT put cookies that contain sensitive data in this list!
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Encryption\Encrypter $encrypter
     * @return void
     */
    ...
    protected function validateValue(string $key, $value)
    {
        return is_array($value)
            ...
            : CookieValuePrefix::validate($key, $value, $this->encrypter->getKey(true));
    }
    ...
    {
        return \in_array($name, $this->except) && !\str_starts_with($name, \MacropaySolutions\Kernel\Auth\SessionGuard::REMEMBER_);
    }
