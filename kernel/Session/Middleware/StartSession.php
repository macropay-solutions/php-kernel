...
namespace MacropaySolutions\Kernel\Session\Middleware;
...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \MacropaySolutions\Kernel\Session\SessionManager
     */
    protected $manager;
     ...
     *
     * @param \MacropaySolutions\Kernel\Session\SessionManager $manager
    ...
    protected function handleStatefulRequest(Request $request, $session, Closure $next)
    {
        ...
        // so that the data is ready for an application. Note that the Kernel sessions
        // do not make use of PHP "native" sessions in any way since they are crappy.
        $request->setFrameworkSession(
    ...
    protected function getCookieExpirationDate()
    {
        ...
        return $expiresOnClose ? 0 : \appDate()->instance(
