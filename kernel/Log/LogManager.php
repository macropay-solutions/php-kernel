...
/**
 * @mixin \MacropaySolutions\Kernel\Log\Logger
 */
class LogManager implements LoggerInterface
{
     ...
     *
     * @param string $name
     * @param \MacropaySolutions\Kernel\Log\Logger $logger
    ...
    protected function createEmergencyLogger()
    {
        ...
        $handler = new StreamHandler(
            $config['path'] ?? $this->app->storagePath() . '/logs/framework.log',
    ...
    /**
     * Get all the resolved log channels.
     *
     * @return array
     */
     ...
     * Dynamically call the default driver instance.
     */
    public function fwd(): \Psr\Log\LoggerInterface|\MacropaySolutions\Kernel\Log\Logger
    {
        return $this->driver();
    }
}
