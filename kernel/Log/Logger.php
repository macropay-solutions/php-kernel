...
class Logger implements LoggerInterface
{
     ...
     *
     * @param Arrayable|\MacropaySolutions\Kernel\Contracts\Support\Jsonable|\MacropaySolutions\Kernel\Support\Stringable|array|string $message
     * @param array $context
     * @return void
     */
    ...
    protected function fireLogEvent($level, $message, array $context = [])
    {
        ...
        // that aggregate all the log messages for a given "request" cycle.
        if (isset($this->dispatcher)) {
