...
//        return new static(...$parameters);
        return \di(static::class, $parameters);
    }
     ...
     *
     * @param mixed $resource
     * @return \MacropaySolutions\Kernel\Http\Resources\Json\AnonymousResourceCollection
     */
...
//                $collection->preserveKeys = (new static([]))->preserveKeys === true;
                $collection->preserveKeys = \di(static::class, [[]])->preserveKeys === true;
            }
        });
    }
...
//        return new AnonymousResourceCollection($resource, static::class);
        return \di(AnonymousResourceCollection::class, [$resource, static::class]);
    }

    /**
     * Resolve the resource to an array.
     *
     * @param \MacropaySolutions\Kernel\Http\Request|null $request
     * @return array
     */
     ...
     * @return array|\MacropaySolutions\Kernel\Contracts\Support\Arrayable|\JsonSerializable
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Http\Request $request
     * @param \MacropaySolutions\Kernel\Http\JsonResponse $response
     * @return void
     */
