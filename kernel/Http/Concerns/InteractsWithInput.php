...
namespace MacropaySolutions\Kernel\Http\Concerns;
...
trait InteractsWithInput
{
     ...
     * @param string $key
     * @param mixed $default
     * @return \MacropaySolutions\Kernel\Support\Stringable
     */
     ...
     * @return \MacropaySolutions\Kernel\Support\Carbon|null
     *
    ...
    public function date($key, $format = null, $tz = null)
    {
        ...
        if (is_null($format)) {
            return \appDate()->parse($this->input($key), $tz);
        }

        return \appDate()->createFromFormat($format, $this->input($key), $tz);
    }
    ...
    /**
     * Convert the given array of Symfony UploadedFiles to custom Kernel UploadedFiles.
     *
     * @param array $files
     * @return array
     */
     ...
     * @param string|null $key
     * @param mixed $default
     * @return \MacropaySolutions\Kernel\Http\UploadedFile|\MacropaySolutions\Kernel\Http\UploadedFile[]|array|null
     */
