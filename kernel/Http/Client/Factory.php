...
/**
 * @mixin \MacropaySolutions\Kernel\Http\Client\PendingRequest
 */
class Factory
{
    use Macroable {
     ...
     *
     * @var \MacropaySolutions\Kernel\Contracts\Events\Dispatcher|null
     */
     ...
     * @return \MacropaySolutions\Kernel\Http\Client\ResponseSequence
     */
    public function sequence(array $responses = [])
    {
//        return $this->responseSequences[] = new ResponseSequence($responses);
        return $this->responseSequences[] = \di(ResponseSequence::class, [$responses]);
    }
     ...
     *
     * @param string $url
     * @param \MacropaySolutions\Kernel\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface|callable $callback
     * @return $this
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Http\Client\PendingRequest
     */
    protected function newPendingRequest()
    {
//        return (new PendingRequest($this, $this->globalMiddleware))->withOptions($this->globalOptions);
        return (\di(PendingRequest::class, [$this, $this->globalMiddleware]))->withOptions($this->globalOptions);
    }
