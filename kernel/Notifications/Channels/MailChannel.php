...
use MacropaySolutions\Kernel\Mail\Markdown;
...
class MailChannel
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Contracts\Mail\Factory
     */
    protected $mailer;
     ...
     *
     * @var \MacropaySolutions\Kernel\Mail\Markdown
     */
    protected $markdown;
     ...
     *
     * @param \MacropaySolutions\Kernel\Contracts\Mail\Factory $mailer
     * @param \MacropaySolutions\Kernel\Mail\Markdown $markdown
     * @return void
     */
     ...
     * @param mixed $notifiable
     * @param \MacropaySolutions\Kernel\Notifications\Notification $notification
     * @param \MacropaySolutions\Kernel\Notifications\Messages\MailMessage $message
     * @return \Closure
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Notifications\Messages\MailMessage $message
     * @return \MacropaySolutions\Kernel\Mail\Markdown
     */
    ...
    {
        return [
            '__framework_notification_id' => $notification->id,
            '__framework_notification' => get_class($notification),
            '__framework_notification_queued' => in_array(
                ShouldQueue::class,
     ...
     *
     * @param \MacropaySolutions\Kernel\Mail\Message $mailMessage
     * @param mixed $notifiable
     * @param \MacropaySolutions\Kernel\Notifications\Notification $notification
     * @param \MacropaySolutions\Kernel\Notifications\Messages\MailMessage $message
     * @return void
