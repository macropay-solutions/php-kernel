...
class ApcStore extends TaggableStore
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Cache\ApcWrapper
     */
    protected $apc;
     ...
     *
     * @param \MacropaySolutions\Kernel\Cache\ApcWrapper $apc
     * @param string $prefix
     * @return void
     */
    ...
    public function touch(string $key, int $seconds): bool
    {
        ...
        return (bool)$this->apc->put($key, $value, $seconds);
    }
    ...
    {
        return $this->apc->add($this->prefix . $key, $value, $seconds);
    }
}
