...
namespace MacropaySolutions\Kernel\Mail\Mailables;
...
class Envelope
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Mail\Mailables\Address|string|null
     */
    public $from;
     ...
     *
     * @param \MacropaySolutions\Kernel\Mail\Mailables\Address|string|null $from
     * @param array<int, \MacropaySolutions\Kernel\Mail\Mailables\Address|string> $to
     * @param array<int, \MacropaySolutions\Kernel\Mail\Mailables\Address|string> $cc
     * @param array<int, \MacropaySolutions\Kernel\Mail\Mailables\Address|string> $bcc
     * @param array<int, \MacropaySolutions\Kernel\Mail\Mailables\Address|string> $replyTo
     ...
     *
     * @param array<int, \MacropaySolutions\Kernel\Mail\Mailables\Address|string> $addresses
     * @return array<int, \MacropaySolutions\Kernel\Mail\Mailables\Address>
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Mail\Mailables\Address|string $address
     ...
     *
     * @param \MacropaySolutions\Kernel\Mail\Mailables\Address|array<int, \MacropaySolutions\Kernel\Mail\Mailables\Address|string>|string $address
     * @param string|null $name
     * @return $this
     */
