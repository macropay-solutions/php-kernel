...
use MacropaySolutions\Kernel\Contracts\Mail\MailQueue as MailQueueContract;
use MacropaySolutions\Kernel\Contracts\Queue\Factory as QueueContract;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @var \MacropaySolutions\Kernel\Contracts\View\Factory
     */
    protected $views;
     ...
     *
     * @param string $name
     * @param \MacropaySolutions\Kernel\Contracts\View\Factory $views
     * @param \Symfony\Component\Mailer\Transport\TransportInterface $transport
     * @param \MacropaySolutions\Kernel\Contracts\Events\Dispatcher|null $events
     * @return void
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Mail\Message $message
     * @param string $view
     * @param string $plain
     * @param string $raw
     * @param array $data
     ...
     *
     * @param string $queue
     * @param \MacropaySolutions\Kernel\Contracts\Mail\Mailable $view
     * @return mixed
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Mail\Message
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Contracts\View\Factory
     */
