...
//        return new static(fn($attachment, $pathStrategy) => $pathStrategy($path, $attachment));
        return \di(static::class, [fn($attachment, $pathStrategy) => $pathStrategy($path, $attachment)]);
    }
...
//        return new static(function ($attachment, $pathStrategy, $dataStrategy) use ($disk, $path) {
        return \di(static::class, [function ($attachment, $pathStrategy, $dataStrategy) use ($disk, $path) {
     ...
     *
     * @param \MacropaySolutions\Kernel\Mail\Mailable|\MacropaySolutions\Kernel\Mail\Message|\MacropaySolutions\Kernel\Notifications\Messages\MailMessage $mail
     * @param array $options
     * @return mixed
     */
