...
use MacropaySolutions\Kernel\Contracts\Mail\Factory as FactoryContract;
use MacropaySolutions\Kernel\Log\LogManager;
use MacropaySolutions\Kernel\Mail\Transport\ArrayTransport;
use MacropaySolutions\Kernel\Mail\Transport\LogTransport;
use MacropaySolutions\Kernel\Mail\Transport\SesTransport;
use MacropaySolutions\Kernel\Mail\Transport\SesV2Transport;
...
//        $mailer = new Mailer(
     ...
     *
     * @param array $config
     * @return \MacropaySolutions\Kernel\Mail\Transport\SesTransport
     */
     ...
     *
     * @param array $config
     * @return \MacropaySolutions\Kernel\Mail\Transport\SesV2Transport
     */
     ...
     *
     * @param array $config
     * @return \MacropaySolutions\Kernel\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \MacropaySolutions\Kernel\Mail\Transport\ArrayTransport
     */
    ...
    /**
     * Forget all the resolved mailer instances.
     *
     * @return $this
     */
