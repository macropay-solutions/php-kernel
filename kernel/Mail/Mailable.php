...
class Mailable implements MailableContract, Renderable, Macroable
{
    use Conditionable;
    use ForwardsCalls;
    use Localizable;
    ...
    /**
     * Add all the attachments to the message.
     *
     * @param \MacropaySolutions\Kernel\Mail\Message $message
     * @return $this
     */
    ...
    /**
     * Add all the disk attachments to the message.
     *
     * @param \MacropaySolutions\Kernel\Mail\Message $message
     * @return void
     */
     ...
     *
     * @param string|\MacropaySolutions\Kernel\Contracts\Mail\Attachable|\MacropaySolutions\Kernel\Mail\Attachment $file
     * @param array $options
     * @return $this
     */
     ...
     *
     * @param \MacropaySolutions\Kernel\Mail\Attachment $attachment
     * @param array $options
     * @return bool
     */
