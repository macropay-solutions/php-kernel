...
use Illuminate\Console\AutowiringMethodsCacheCommand;
use Illuminate\Console\AutowiringMethodsClearCommand;
use Illuminate\Console\CommandsCacheCommand;
use Illuminate\Console\CommandsClearCommand;
use Illuminate\Console\EventCacheCommand;
use Illuminate\Console\EventClearCommand;
use Illuminate\Console\MergeCachedFilesCacheCommand;
use Illuminate\Console\MergeCachedFilesClearCommand;
use Illuminate\Console\Scheduling\ScheduleFinishCommand;
use Illuminate\Console\Scheduling\ScheduleRunCommand;
use Illuminate\Console\Scheduling\ScheduleWorkCommand;
use Illuminate\Console\ViewCacheCommand;
use Illuminate\Console\ViewClearCommand;
...
use Illuminate\Queue\Console\FailJobCommand as QueueFailJobCommand;
