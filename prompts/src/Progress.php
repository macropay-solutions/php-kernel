...
class Progress extends Prompt
{
    ...
    public function __construct(public string $label, public iterable|int $steps, public string $hint = '')
    {
         ...
         * (PHPStan doesn't parse that we convert from iterable to int in the below match)
         */
        $this->total = match (true) {
             ...
             * (Technically we shouldn't be able to reach the default as should be int|countable|iterable )
             */
